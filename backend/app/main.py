...
from app.routers import aws_auth, auth_router, chat, ec2_starter, s3_starter, vpc_starter
...
app.include_router(s3_starter.router)
app.include_router(ec2_starter.router)
